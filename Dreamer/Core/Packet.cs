...
namespace Dreamer.Core
{
    public class Packet
    {
        ...
        public DarkagesProcess DarkagesProcess { get; set; }
        ...
        public byte this[int index]
        {
            ...
            set
            {
                //if (DarkagesProcess.Memory != null && DarkagesProcess.Memory == null && !DarkagesProcess.Memory.IsRunning) return;
                //if (Type == 2 && DarkagesProcess.SendPointer != 0)
                //    if (DarkagesProcess.Memory != null)
                //        DarkagesProcess.Memory.Write((IntPtr)DarkagesProcess.SendPointer + index, value, false);
                //if (Type == 1 && DarkagesProcess.RecvPointer != 0)
                //    if (DarkagesProcess.Memory != null)
                //        DarkagesProcess.Memory.Write((IntPtr)DarkagesProcess.RecvPointer + index, value, false);
            }
        }

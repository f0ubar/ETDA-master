...
namespace BotCore
{
    ...
    public abstract partial class GameClient : UpdateableComponent
    {
        ...
        public Magic Magic;
        public GameEquipment GameEquipment;
        public Activebar Activebar;
        ...
        private void PrepareComponents()
        {
            ...
            InstalledComponents.Add(Inventory = new Inventory {Client = this, Enabled = true});
            InstalledComponents.Add(PlayerAttributes = new PlayerAttributes {Client = this, Enabled = true});
            InstalledComponents.Add(Magic = new Magic {Client = this, Enabled = true});
            InstalledComponents.Add(GameEquipment = new GameEquipment {Client = this, Enabled = true});
            InstalledComponents.Add(Activebar = new Activebar {Client = this, Enabled = true});
            InstalledComponents.Add(TargetFinder = new TargetFinder {Client = this, Enabled = true});

            //disabled by default components
            InstalledComponents.Add(StressTest = new StressTest {Client = this, Enabled = false});
        ...
        public PlayerAttributes Attributes
        {
            get
            {
                ...
                //var obj = InstalledComponents.ToList().OfType<PlayerAttributes>()
                //    .FirstOrDefault();

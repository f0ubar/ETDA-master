...
namespace Bot
{
    class Program
    {
        ...
        {
            Console.WriteLine("Starting SetupComponents");
        ...
        static void monitor_Attached(object sender, EventArgs e)
        {
            ...
            Console.WriteLine("Ending monitor_Attached");
        }

        public static void InjectCodeStubs(GameClient client)
        {
            Console.WriteLine("Starting InjectCodeStubs");
            ...
            Console.WriteLine("Ending InjectCodeStubs");
        }
        ...
        {
            Console.WriteLine("Starting DoUpdate");
            while (true)
            {
                Console.WriteLine("DoUpdate Loop");
            ...
            Console.WriteLine("Ending DoUpdate Loop");
        }

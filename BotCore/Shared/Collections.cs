...
namespace BotCore
{
    public static class Collections
    {
        ...
        private static void LoadBaseSpells()
        {
            ...
            BaseSpells["beag athar"] = new BaseSpellInformation("beag athar", "Wizard", "athar", 20, 2);
            ...
            BaseSpells["beag sal"] = new BaseSpellInformation("beag sal", "Wizard", "sal", 20, 2);
            ...
            BaseSpells["beag srad"] = new BaseSpellInformation("beag srad", "Wizard", "srad", 20, 2);

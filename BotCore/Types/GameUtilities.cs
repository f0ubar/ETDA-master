...
namespace BotCore
{
    public class GameUtilities
    {
        ...
        public bool CastSpell(string spellName, MapObject target)
        {
            ...
            var spell = Client.GameMagic[basespell.Name];
            spell.UnequipedLines = basespell.BaseLines;
            spell.EquipedLines = basespell.BaseLines;
            if (spell == null)
            {
                return false;
            }
        ...
        private bool Cast(MapObject target, Spell spell)
        {
            spell.EquipedLines = spell.UnequipedLines;
            ...
            if (spell.EquipedLines > 0)
            {
                if (spell.CastName == null)
                    spell.CastName = spell.Name.Substring(0, spell.Name.IndexOf('(') - 1);
